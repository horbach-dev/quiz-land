...
export const getInitialStep = (nextQuestionId: string, questions: TQuizQuestion[]) => {
  const initialStepIndex = nextQuestionId ? questions.findIndex((q) => q.id === nextQuestionId) : 0;
